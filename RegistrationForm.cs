...
namespace PROJECT
{
    public partial class RegistrationForm : Form
    {
        ...
        private static String path = @"C:\Users\Hassnain\Desktop\Conn folder";
        CaptureForm capture = new CaptureForm();
        private SqlConnection con = new SqlConnection("Data Source=HASSNAINSHAH-PC\\HASSNAIN;Initial Catalog=EnrolmentSystem;Integrated Security=True");
